...
{
    [Area("EN")]
    public class AlbumsENController : Controller
    {
        public IActionResult Index([FromQuery] SearchCategoriesAblums dto)
        {
            ...
            ListCatAblum = CategoriesAblumsService.GetListPagination(data.SearchData, API.Models.Settings.SecretId + ControllerName);
