...
{
    public class QuyenGopTaiLieuService
    {
        public static List<QuyenGopTaiLieu> GetListPagination(SearchQuyenGopTaiLieu dto, string SecretId)
        {
            ...
            var tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_QuyenGopTaiLieu",
            ...
            if (tabl == null)
            {
                return new List<QuyenGopTaiLieu>();
            }
            else
            {
                return (from r in tabl.AsEnumerable()
                        select new QuyenGopTaiLieu
                        {
                            Id = (int)r["Id"],
        ...
        public static List<QuyenGopTaiLieu> GetListPaginationClient(SearchQuyenGopTaiLieu dto, string SecretId)
        {
            if (dto.CurrentPage <= 0)
            {
                dto.CurrentPage = 1;
        ...
        public static QuyenGopTaiLieu GetItem(decimal Id, string SecretId = null, string LangId = "VI")
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_QuyenGopTaiLieu",
            new string[] { "@flag", "@Id", "@LangId" }, new object[] { "GetItem", Id, LangId });
            QuyenGopTaiLieu Item = (from r in tabl.AsEnumerable()
                                       select new QuyenGopTaiLieu
                                       {
                                           Id = (int)r["Id"],
                                           CamNghi = (string)((r["CamNghi"] == System.DBNull.Value) ? null : r["CamNghi"]),
        ...
        public static dynamic SaveItem(QuyenGopTaiLieu dto)
        {
        ...
        public static dynamic DeleteItem(QuyenGopTaiLieu dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_QuyenGopTaiLieu",
        ...
        public static dynamic UpdateStatus(QuyenGopTaiLieu dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_QuyenGopTaiLieu",
