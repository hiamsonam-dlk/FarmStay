...
{
    public class Phieu_DiDoiNangHaService
    {
        public static List<Phieu_DiDoiNangHa> GetListPagination(SearchPhieu_DiDoiNangHa dto, string SecretId)
        {
            ...
            var tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_Phieu_DiDoi_NangHa",
            ...
            if (tabl == null)
            {
                return new List<Phieu_DiDoiNangHa>();
            }
            else
            {
                return (from r in tabl.AsEnumerable()
                        select new Phieu_DiDoiNangHa
                        {
                            Id = (int)r["Id"],
        ...
        public static Phieu_DiDoiNangHa GetItem(decimal Id, string SecretId = null, string LangId = "VI")
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_Phieu_DiDoi_NangHa",
            new string[] { "@flag", "@Id", "@LangId" }, new object[] { "GetItem", Id, LangId });
            Phieu_DiDoiNangHa Item = (from r in tabl.AsEnumerable()
                                       select new Phieu_DiDoiNangHa
                                       {
                                           Id = (int)r["Id"],
                                           TenKH = (string)((r["TenKH"] == System.DBNull.Value) ? null : r["TenKH"]),
                                           Status = (int)r["Status"],
                                           IdTacVu = (int)r["IdTacVu"],
        ...
        public static dynamic SaveItem(Phieu_DiDoiNangHa dto)
        {
            ...
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_Phieu_DiDoi_NangHa",
            new string[] { "@flag", "@Id", "@TenKH", "@SoDT", "@DiaChi", "@Status", "@CreatedBy", "@UpdatedBy", "@CreatedAt", "@UpdatedAt", "@LoaiHinhTiepNhan", "@NhanVienKhaoSat", "@Deleted", "@NgayTao", "@NoiDungYeuCau", "@IdTacVu" },
            new object[] { "SaveItem", dto.Id, dto.TenKH, dto.SoDT, dto.DiaChi, dto.Status, dto.CreatedBy, dto.UpdatedBy, dto.CreatedAt, dto.UpdatedAt, dto.LoaiHinhTiepNhan, dto.NhanVienKhaoSat, dto.Deleted, NgayDang, dto.NoiDungYeuCau, dto.IdTacVu});
            return (from r in tabl.AsEnumerable()
                    select new
                    {
                        N = (int)(r["N"]),
        ...
        public static dynamic DeleteItem(Phieu_DiDoiNangHa dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_Phieu_DiDoi_NangHa",
        ...
        public static dynamic UpdateStatus(Phieu_DiDoiNangHa dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_Phieu_DiDoi_NangHa",
