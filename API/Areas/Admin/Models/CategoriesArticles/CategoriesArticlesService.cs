...
namespace API.Areas.Admin.Models.CategoriesArticles
{
    ...
    {
        public static List<CategoriesArticles> GetListPagination(SearchCategoriesArticles dto, string SecretId,string LangId="VI")
        {
        ...
        public static List<CategoriesArticles> GetList(Boolean Selected = true, string LangId = "VI")
        {
        ...
        public static List<CategoriesArticles> GetListFeaturedHome(string LangId = "VI")
        {
        ...
        public static List<CategoriesArticlesDropDown> GetListItemsDropDown(int ParentId=0,string LangId = "VI", int UserId = 0)
        {

            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_CategoriesArticles",
                new string[] { "@flag", "@ParentId", "@LangId", "@UserId" }, new object[] { "GetListDropDown", ParentId,LangId,UserId });
            List<CategoriesArticlesDropDown> ListItems = (from r in tabl.AsEnumerable()
                                              select new CategoriesArticlesDropDown
                                              {
                                                  Id = (int)r["Id"],
                                                  Title = (string)((r["Title"] == System.DBNull.Value) ? null : r["Title"]),
        ...
        public static CategoriesArticles GetItembyName(string Name)
        {
        ...
        public static dynamic SaveItem(CategoriesArticles dto)
        {
            ...
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_CategoriesArticles",
            new string[] { "@flag","@Id","@Title","@Alias","@Description","@ParentId","@Status","@Deleted","@CreatedBy","@ModifiedBy","@Metadesc","@Metakey","@Metadata","@Images","@Params","@Ordering","@Hits", "@FeaturedHome","@Type", "@LangId", "@Ten", "@MoTa" },
            new object[] { "SaveItem",dto.Id,dto.Title,dto.Alias,dto.Description,dto.ParentId,dto.Status,dto.Deleted,dto.CreatedBy,dto.ModifiedBy,dto.Metadesc,dto.Metakey,dto.Metadata,dto.Images,dto.Params,dto.Ordering,dto.Hits ,dto.FeaturedHome,dto.Type,dto.LangId, dto.Ten, dto.MoTa});
            return (from r in tabl.AsEnumerable()
                    select new
                    {
                        N = (int)(r["N"]),
