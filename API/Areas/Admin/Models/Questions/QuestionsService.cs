...
using API.Models;
namespace API.Areas.Admin.Models.Questions
{
    public class QuestionsService
    {
        public static List<Questions> GetListPagination(SearchQuestions dto, string SecretId)
        {
            ...
            var tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_Questions",
        ...
        public static List<Questions> GetListPaginationFront(SearchQuestions dto, string SecretId)
        {
            if (dto.CurrentPage <= 0)
            {
                dto.CurrentPage = 1;
            ...
            else
            {
                return (from r in tabl.AsEnumerable()
                        select new Questions
                        {
                            ...
                            Ids = MyModels.Encode((int)r["Id"], SecretId),
                            CreatedDate = (DateTime)r["CreatedDate"],
                            CreatedDateShow = (string)((r["CreatedDate"] == System.DBNull.Value) ? DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") : (string)((DateTime)r["CreatedDate"]).ToString("dd/MM/yyyy HH:mm:ss")),
                            TotalRows = (int)r["TotalRows"],
                        }).ToList();
            }
        ...
        public static List<Questions> GetList(Boolean Selected = true)
        {
            
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_Questions",
        ...
        public static Questions GetItem(decimal Id, string SecretId = null)
        {
        ...
        public static dynamic SaveItem(Questions dto)
        {
        ...
        public static dynamic DeleteItem(Questions dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_Questions",
        ...
        public static dynamic UpdateStatus(Questions dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_Questions",
