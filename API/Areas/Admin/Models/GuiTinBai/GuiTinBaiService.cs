...
{
    public class GuiTinBaiService
    {
        public static List<GuiTinBai> GetListPagination(SearchGuiTinBai dto, string SecretId)
        {
            ...
            var tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_GuiTinBai",
            ...
            if (tabl == null)
            {
                return new List<GuiTinBai>();
            }
            else
            {
                return (from r in tabl.AsEnumerable()
					select new GuiTinBai
					{
						Id = (int)r["Id"],
        ...
        public static List<GuiTinBai> GetListPaginationFront(SearchGuiTinBai dto, string SecretId)
        {
            if (dto.CurrentPage <= 0)
            {
                dto.CurrentPage = 1;
        ...
        public static List<GuiTinBai> GetList(Boolean Selected = true)
        {
            
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_GuiTinBai",
        ...
        public static GuiTinBai GetItem(decimal Id, string SecretId = null)
        {
        ...
        public static dynamic SaveItem(GuiTinBai dto)
        {
        ...
        public static dynamic DeleteItem(GuiTinBai dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_GuiTinBai",
        ...
        public static dynamic UpdateStatus(GuiTinBai dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_GuiTinBai",
