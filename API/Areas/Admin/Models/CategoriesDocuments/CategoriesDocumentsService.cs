...
{
    public class CategoriesDocumentsService
    {
        public static List<CategoriesDocuments> GetListPagination(SearchCategoriesDocuments dto, string SecretId,string LangId="VI")
        {
            ...
            var tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_CategoriesDocuments",
            ...
            if (tabl == null)
            {
                return new List<CategoriesDocuments>();
            }
            else
            {
                return (from r in tabl.AsEnumerable()
					select new CategoriesDocuments
					{
						Id = (int)r["Id"],
        ...
        public static List<CategoriesDocuments> GetList(Boolean Selected = true, string LangId = "VI")
        {
            
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_CategoriesDocuments",
        ...
        public static List<CategoriesDocuments> GetListFeaturedHome(string LangId = "VI")
        {
        ...
        public static List<CategoriesDocumentsDropDown> GetListItemsDropDown(int ParentId=0,string LangId = "VI", int UserId = 0)
        {

            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_CategoriesDocuments",
                new string[] { "@flag", "@ParentId", "@LangId", "@UserId" }, new object[] { "GetListDropDown", ParentId,LangId,UserId });
            List<CategoriesDocumentsDropDown> ListItems = (from r in tabl.AsEnumerable()
                                              select new CategoriesDocumentsDropDown
                                              {
                                                  Id = (int)r["Id"],
                                                  Title = (string)((r["Title"] == System.DBNull.Value) ? null : r["Title"]),
        ...
        public static CategoriesDocuments GetItem(decimal Id, string SecretId = null)
        {
        ...
        public static CategoriesDocuments GetItembyName(string Name)
        {
        ...
        public static CategoriesDocuments GetItemByAlias(string Alias, string SecretId = null)
        {
        ...
        public static List<CategoriesDocuments> GetListChild(int Id,int limit=100)
        {
        ...
        public static dynamic SaveItem(CategoriesDocuments dto)
        {
        ...
        public static dynamic DeleteItem(CategoriesDocuments dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_CategoriesDocuments",
		...
		public static dynamic UpdateStatus(CategoriesDocuments dto)
        {
            DataTable tabl = ConnectDb.ExecuteDataTableTask(Startup.ConnectionString, "SP_CategoriesDocuments",
